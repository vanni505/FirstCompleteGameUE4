...
void AEnemy::MoveToTarget(AMyCharacter* Target)
{
	...
	if (AIController)
	{
		...
		MoveRequest.SetAcceptanceRadius(10.0f); //distanza di collisione fra le due capsule
		...
		for (auto Point : PathPoints)
		{
			...
			UKismetSystemLibrary::DrawDebugSphere(this, Location, 25.f, 8, FLinearColor::Black, 10.f, 1.8f);
